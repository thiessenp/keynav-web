...
/**
 * Adds Keyboard navigation to HTML elements, probably a List, using CSS
 * Selectors.
 *
 ...
 */
export class Keynav {
  // Moving to delegation - NOPE > Delegation NOT used to allow a more flexible
  // list structure & traversal
  // items = [];
